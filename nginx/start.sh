...
then
    ...
    case $1 in
        all)
          for file in acredapi-nginx acredapi-internal-nginx httpsrv-nginx http-redirect-nginx 
          do
        ...
        ;;
        api)
          for file in acredapi-nginx acredapi-internal-nginx
          do
            [ -f $file ] && mv -v $file /etc/nginx/conf.d/$file.conf 
          done
        ...
        http)
          ...
          rm -vf acredapi-nginx acredapi-internal-nginx
